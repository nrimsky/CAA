...
python analysis/plot_results.py --type in_distribution --layers $(seq 10 25) --multipliers -3 -2 -1.5 -1 -0.5 0 0.5 1 1.5 2 3 --few_shot none --model_size "7b"
...
# Plot results
echo "Plotting results"
python analysis/plot_results.py --type out_of_distribution --layers $(seq 15 19) --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --max_new_tokens 100 --model_size "7b"