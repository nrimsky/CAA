...
python prompting_with_steering.py --type in_distribution --layers 15 --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --few_shot unbiased
...
python prompting_with_steering.py --type out_of_distribution --layers 15 --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --max_new_tokens 100

# TruthfulQA tests
python prompting_with_steering.py --type truthful_qa --layers 15 --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --few_shot unbiased
