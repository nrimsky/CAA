...
python prompting_with_steering.py --type out_of_distribution --layers $(seq 15 16) --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --max_new_tokens 100 --model_size "13b"
...
# Plot results
echo "Plotting results"
python plot_results.py --type out_of_distribution --layers $(seq 15 16) --multipliers -1.5 -1 -0.5 0 0.5 1 1.5 --max_new_tokens 100 --model_size "13b"